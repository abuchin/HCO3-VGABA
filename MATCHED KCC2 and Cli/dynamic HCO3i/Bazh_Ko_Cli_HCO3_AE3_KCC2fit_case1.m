...
% KCC2 is removed since Cli is a parameter
...
dts=Tst/Hz_stim;                 % shift for stimulation frequency
...
% AMPA ext
 ...
 V_NKCC1=(VKe+VNAe)/2;
 % VHCO3
 V_HCO3=(R*Temp/F)*log(HCO3i/HCO3o)*1000;
...
Cli(i+1)=kCL_E/F*(ICL + Ikcc2_E*(VKe-VCL)/((VKe-VCL)+Vhalf_E) +Imax_AE3*(V_HCO3-VCL)/((V_HCO3-VCL)+V_half_AE3) )*dt + Cli(i);
...
CLI(1:length(t))=Cli;           % auxilary variable
HCO3(1:length(t))=HCO3i;
